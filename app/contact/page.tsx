  ...
  return (
    <main className="container mx-auto px-8 py-16">
          ...
          <Card className="shadow-lg">
            ...
            <CardContent>
              <form className="space-y-4">
                ...
                <Button
                  variant="outline"
                  className="w-full text-gray-800 border-gray-800 hover:bg-gray-800 hover:text-white"
                  onClick={(e) => {
                    e.preventDefault();
      ...
      <section className="mt-16 text-center">
        <h2 className="text-3xl font-semibold text-gray-900 mb-6">Our Location</h2>
